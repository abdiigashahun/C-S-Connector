    ...
    <main className="relative min-h-screen overflow-x-clip bg-background">
      ...
      <header className="fixed inset-x-0 top-0 z-30 border-b bg-background/90 backdrop-blur supports-backdrop-filter:bg-background/75">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3">
          ...
          >
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-br from-red-600 via-rose-500 to-orange-500 text-sm font-bold text-white shadow-sm ring-1 ring-black/5 transition duration-300 group-hover:scale-105 group-hover:shadow-md">
              SC
            </span>
